...
export const api = {
  ...
  chatSessions: (page = 1, pageSize = 50) => request<any>(`/api/ai/chat/sessions?page=${page}&page_size=${pageSize}`),
  chatSession: (sessionId: string) => request<any>(`/api/ai/chat/sessions/${encodeURIComponent(sessionId)}`),
